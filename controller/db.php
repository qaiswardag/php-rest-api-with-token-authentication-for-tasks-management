...
class DB
{
    ...
    public static function connectWriteDB()
    {
        ...
        if (self::$writeDBConnection === null) {
            self::$writeDBConnection = new PDO("mysql:host=localhost;dbname=vbtvppsykw;charset=utf8", "qais", "ew8Uy5V7pZ");
    ...
    public static function connectReadDB()
    {
        if (self::$readDBConnection === null) {
            self::$readDBConnection = new PDO("mysql:host=localhost;dbname=vbtvppsykw;charset=utf8", "qais", "ew8Uy5V7pZ");
            // Exception: for error mode for the database connections. we are able to catch Exeption
